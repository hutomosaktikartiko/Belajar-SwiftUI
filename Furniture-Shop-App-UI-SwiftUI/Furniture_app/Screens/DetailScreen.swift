...
//  Furniture_app
//
//  Created by Hutomo Sakti Kartiko on 18/07/21.
//
...
struct DescriptionView: View {
    var body: some View {
        VStack (alignment: .leading) {
            ...
            Text("Luxury Swedian Chair ia a contemporary chair based on the virtues of moder craft. it carries on the simplicity and honestly if the archetypical chair.")
                .lineSpacing(8.0)
                .opacity(0.6)
